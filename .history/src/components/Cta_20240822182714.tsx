...
export const Cta = () => {
  return (
    ...
    >
      <video className="w-full h-full object-center object-cover aspect-video md:aspect-square -mt-28" autoPlay loop muted controls preload="none">
          <source src={'./bg-laminado.mp4'} type="video/mp4" />
          <track

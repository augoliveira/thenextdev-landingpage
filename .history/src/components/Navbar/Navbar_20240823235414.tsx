...
const Navbar = (props: Props) => {
  ...
  const [navColor, setNavColor] = useState("#010e0");

  const listenScrollEvent = () => {
    window.scrollY > 10 ? setNavColor("#063b14") : setNavColor("");
  ...
  return (
    ...
    className="w-fit h-[90px] bg-transparent fixed top-0 z-50 px-4 nav"
    >

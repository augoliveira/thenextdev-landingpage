...
const Navbar = (props: Props) => {
  ...
  return (
    ...
    className="w-full h-[90px] bg-transparent fixed top-0 z-50 px-4 py-4 nav"
    >
        <button className='hidden'></button>
        <div className='px-20 flex items-center max-lg:justify-between max-lg:flex-row-reverse'>

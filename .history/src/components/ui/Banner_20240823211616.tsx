  ...
  return (
    <div className="w-full bg-primaryColor pt-10">
      ...
      >
        ...
        <div className="absolute -bottom-0 mdl:bottom-0 flex mdl:flex-row items-start px-4 mdl:items-center bg-transparent justify-center gap-2 mdl:gap-6 text-[14px] text-gray-400 py-4 w-full bg-primaryColor">

...
const Banner = () => {
  const sliderContent = [
    {
      ...
      subtitle: "Envidraçamento de Varanda?",
      desTitle: "ReactBD",
  ...
  return (
    <div className="relative min-h-screen-7xl select-none overflow-hidden bg-primaryColor">
      <div
        className={`${sliderContent[currentSlide].backgroundClass} transition-bg duration-1000 w-full h-screen bg-contain bg-no-repeat xl:bg-cover bg-center font-titleFont relative py-10 mdl:py-32`}
      >

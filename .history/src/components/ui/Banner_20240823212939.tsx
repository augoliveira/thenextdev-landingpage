...
const Banner = () => {
  ...
  return (
    <div className="relative min-h-full select-none overflow-hidden bg-primaryColor">
      <div
        className={`${sliderContent[currentSlide].backgroundClass} transition-bg duration-1000 w-full h-f bg-contain bg-no-repeat xl:bg-cover bg-center font-titleFont relative py-10 mdl:py-32`}
      >

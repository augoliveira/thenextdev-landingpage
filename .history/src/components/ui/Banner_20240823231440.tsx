  ...
  const sliderContent = [
    {
      ...
      desTitle: "Vidraçaria",
      des: "com mais de 14 anos de experiência no mercado, oferecendo serviços de alta qualidade e soluções em vidros para nossos clientes. Nossa empresa é reconhecida por sua excelência, compromisso e atendimento personalizado.",

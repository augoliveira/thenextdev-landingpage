...
const Banner = () => {
  ...
  return (
    <div className="w-full">
      <div
        className={`${sliderContent[currentSlide].backgroundClass} transition-bg duration-1000 w-full bg-cover bg-no-repeat xl:bg-cover bg-center font-titleFont relative py-10 mdl:py-3`}
      >

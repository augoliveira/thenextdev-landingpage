...
const Banner = () => {
  ...
  return (
    <div className="w-full">
      <div
        className={`${sliderContent[currentSlide].backgroundClass} transition-bg duration-1000 w-full bg-cover bg-no-repeat xl:bg-cover bg-center font-titleFont relative py-10 mdl:py-[5re]`}
      >
        ...
        <div className="absolute -bottom-20 mdl:bottom-0 flex mdl:flex-row items-start px-4 mdl:items-center bg-transparent justify-center gap-2 mdl:gap-6 text-[14px] text-gray-400 py-4 w-full bg-primaryColor">

...
const Banner = () => {
  const sliderContent = [
    ...
    },
    {
      ...
      des: "A VITRON produz Esquadrias de Alumínio sob medida para atender aos mais variados projetos de portões, janelas de correr, grades, veneziana e corrimão.",

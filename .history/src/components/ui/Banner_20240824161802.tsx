...
const Banner = () => {
  const sliderContent = [
    ...
    },
    {
      ...
      des: "A GLAZING DESI produz Esquadrias de Alumínio sob medida para atender aos mais variados projetos de portões, janelas de correr, grades, veneziana e corrimão.",

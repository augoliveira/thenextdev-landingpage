          ...
          <header className="max-w-screen-2xl mx-auto text-white flex items-center justify-between h-full overflow-hidden">
            ...
            <div className="relative">
              ...
              <div
                ...
                className="flex- relative text-2xl w-11 h-11 lgl:hidden flex flex-col gap-[6px] border-b-[1px] border-b-secondaryColor border-t-[1px] text-white border-t-secondaryColor items-center justify-center group hover:cursor-pointer overflow-hidden"
              >
                {toggleNav ? (

        ...
        <div className="w-full h-[90px]">
          <header className="max-w-screen-2xl mx-auto text-white flex items-center justify-between h-full overflow-hidden">
            ...
            <div className="relative">
              <div className="hidden md:block max-w-scr-5xl mx-auto lgl:flex items-center gap-6 xl:gap-12 uppercase font-titleFont tracking-[3px] text-[14px] font-semibold">
                {navigation?.map((item) => (
                  <Link
                    key={item?.title}
                    href={item?.link}

    ...
    <div className="flex flex-col gap-6 xl:gap-8 h-96 justify-center">
      <div>
        <motion.h4
          ...
          className="gradient-text mb-4 max-w-4xl animate-gradient text-4xl font-semibold leading-none tracking-tight text-transparent md:text-5xl xl:text-xl dark:text-purple"
        >
          {title}

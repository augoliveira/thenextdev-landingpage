    ...
    <div className="flex flex-col gap-6 xl:gap-8 h-96 justify-center">
      <div>
        <motion.h4
          ...
          className="gradient-text mb-4 max-w-3xl animate-gradient text-4xl font-normal leading-none tracking-tight text-transparent md:text-5xl xl:text-6xl dark:text-purple"
        >
          {title}

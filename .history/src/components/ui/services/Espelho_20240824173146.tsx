    ...
    <div className="w-full px-6 flex items-center gap-10 mt-14">
      ...
      <div className="w-full lgl:w-3/5">
        ...
        >
          ...
          O <span className="text-base font-extrabold tracking-tight">Espelho GLAZING DESIGN</span> é um Produto exclusivo, oferece grande beleza com resistência a riscos e oxidação. Ideal para diversas aplicações, seja como decoração, revestimento de peças, seja de maneira autoportante, em aplicações como tampos de mesas, estantes, biombos, etc. A VITRON disponibiliza espelhos com acabamento bizotado, recortado e lapidado, com tamanhos grandes e pequenos trazendo um ótimo acabamento e proporcionando uma sensação de que o seu ambiente ficou maior. 
          </p>
          <p className="text-base text-darkText leading-[28px] tracking-wide hover:text-gray-300 duration-300">

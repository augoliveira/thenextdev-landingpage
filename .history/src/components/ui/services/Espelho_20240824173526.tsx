        ...
        >
          ...
          O <span className="text-base font-extrabold tracking-tight">
            Espelho GLAZING DESIGN
              ...
              A VITRON disponibiliza espelhos com acabamento bizotado, recortado e lapidado, com tamanhos grandes e pequenos trazendo um ótimo acabamento e proporcionando uma sensação de que o seu ambiente ficou maior. 
          </p>
          <p className="text-base text-darkText leading-[28px] tracking-wide hover:text-gray-300 duration-300">

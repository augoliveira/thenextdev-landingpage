    ...
    <div className="w-full px-6 flex items-center gap-10 mt-14">
      ...
      <div className="w-full lgl:w-3/5">
        ...
        >
          ...
          <p className="text-base text-darkText leading-[28px] tracking-wide hover:text-gray-300 duration-300">
          Na <span></span>VITRON você encontra Espelhos com preços acessíveis, o melhor acabamentos e instalação rápida e simples, feita por profissionais altamente capacitados.
          </p>
        </motion.div>
        <motion.div
          initial={{ x: 50, opacity: 0 }}

  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
        <h2 className="font-heading text-3xl font-extrabold tracking-tight text-gray-50/90 dark:text-slate-50 sm:text-4xl md:text-6xl">
          Faça uma contação
        </h2>
        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          Faça o investimento de sua obra com quem Intende com mão de obra
          especializada.
        </p>
      </div>
      ...
      <div className="grid w-full items-start gap-10 rounded-lg border p-10 md:grid-cols-[1fr_200px]">
        <div className="grid gap-6">
          <h3 className="text-xl font-bold sm:text-2xl">
            Temos vidros para todas necessidades para seu projeto
          </h3>
          <ul className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
            ...
            <li className="flex items-center">
              <Check className="mr-2 h-4 w-4" /> preecha o formulário e solicite
              sua cotação
            </li>
            <li className="flex items-center">

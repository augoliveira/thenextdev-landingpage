import { CheckBadgeIcon, ChatBubbleBottomCenterTextIcon } from '@heroicons/react/24/outline'
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            <h2 className="text-4xl font-semibold tracking-tight text-white">Bem-vindo à nossa vidraçaria,</h2>
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <CheckBadgeIcon aria-hidden="true" className="size-8 text-white" />
              </div>
              <div className="mt-4 text-base font-semibold text-white">Elegância e Estilo</div>
            ...
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <ChatBubbleBottomCenterTextIcon aria-hidden="true" className="size-8 text-white" />
              </div>
              <div className="mt-4 text-base font-semibold text-white">Valorização da Estética</div>
              <p className="mt-2 text-base/7 text-gray-400">

...
export const PageIntroduction = () => {
  return (
    ...
    <section className="w-full h-[300px] lg:h-[300px] bg-bg-cobertura bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center px-2">
      <motion.div

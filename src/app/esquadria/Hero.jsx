...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="bg-fixed bg-hero-image bg-cover bg-center bg-no-repeat py-16 px-32 my-24 sm:my-32 min-h-lvh pt-[5lvh] pb-[5lvh] pr-[5lvw] pl-[5lvw] flex flex-col justify-between"
    >

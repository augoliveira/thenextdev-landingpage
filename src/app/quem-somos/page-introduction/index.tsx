  ...
  return (
    ...
    <section className="w-full h-[300px] lg:h-[300px] bg-contato-page bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center px-2">
      ...
      >
        ...
        <div className="flex w-54 mt-6 rounded-lg backdrop-blur-sm bg-white/30 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
          <div className="flex items-center space-x-4 px-8 py-2">
          ...
          <NextLink href="/quem-somos" className="cursor-pointer hover-green">
            <span className="text-green-300 bg-hero-page py-4 px-3 rounded-r">
              SOBRE NÓS
            </span>

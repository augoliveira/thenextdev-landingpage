    ...
    <div className="my-10 flex flex-col gap-7 lg:flex-row items-center justify-center md:justify-around">
      <div className="flex items-center gap-3">
        ...
        <div className="font-secondary flex flex-col justify-center items-start">
          <h1 className="font-semibold text-xl text-gray-900">Parcelamento</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="font-secondary flex flex-col justify-center items-start">
          <h1 className="font-semibold text-xl text-gray-900">Boleto e Pix</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="font-secondary flex flex-col justify-center items-start">
          <h1 className="font-semibold text-xl text-gray-900">Entrega garantida</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="font-secondary flex flex-col justify-center items-start">
          <h1 className="font-semibold text-xl text-gray-900">Compra Segura</h1>

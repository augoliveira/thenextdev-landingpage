          ...
          <div className="mt-auto p-4">
            <Card>
              <CardHeader className="p-2 pt-0 md:p-4">
                ...
                <CardDescription>Agende uma visita tecnica!</CardDescription>
              </CardHeader>

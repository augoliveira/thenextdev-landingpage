...
const faqs = [
  ...
  {
    title: 'Escolha o melhor modelo de Box Para Banheiro para pequenos espaços:',
  ...
  {
    title: 'Escolha o Modelo ideal de Box para Banheiro de Canto para sua Residência:',
          ...
          >
            {faqs.map((faq, idx) => (
              <AccordionItem key={idx} value={idx.toString()}>
                ...
                <AccordionContent>
                  <h5 className='text-md text-slate-900 font-extrabold dark:text-slate-200 '>{faq.title}</h5>
